    ...
    <div class=" min_height bg-light">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../apps/resoures/css/img/slide.png" style="width: 100%; height: 550px;" class="d-block w-100" alt="...">
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="row">
                    <?php
                    // truy xuất vào bảng BOOK để lấy thông tin sách hiển thị ra
                    ...
                    while ($row = $sth->fetch()) {
                        echo "
                                    <div class=\"card p-0 mx-4 mt-3 mb-3 hover_large\" style=\"width: 13rem;\">
                                        <a href=\"show_book.php?id={$row['id_sp']}\"><img class=\"card-img-top img_sp \" src=\"{$row['link']}\"></a>
